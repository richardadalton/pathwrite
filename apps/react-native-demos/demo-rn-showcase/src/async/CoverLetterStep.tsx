  ...
  return (
    <View style={styles.body}>
      <Text style={styles.intro}>
        ...
        <Text style={styles.bold}>Software Engineer</Text> or <Text style={styles.bold}>Data Scientist</Text>{" "}
        routes here; other roles skip straight to Review. The step count updates once the skip resolves.
      </Text>
      ...
      <View style={styles.field}>
        <View style={styles.labelRow}>
          ...
          <Text
            style={[
              styles.charCount,
              (snap.data.coverLetter as string).trim().length > 0 &&
