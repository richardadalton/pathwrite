...
<section class="result-panel success-panel">
  ...
  <div class="summary">
    ...
    <div class="summary-section">
      ...
      {#if data.company}<div class="summary-row">
          <span class="summary-key">Company</span><span>{data.company}</span>
        </div>{/if}
      <div class="summary-row">
        <span class="summary-key">Experience</span><span
          >{EXPERIENCE_LABELS[data.experience] ?? data.experience}</span
        >
      </div>
    </div>
    <div class="summary-section">
      ...
      <div class="summary-row">
        <span class="summary-key">Notifications</span><span
          >{data.notifications ? "Enabled" : "Disabled"}</span
        >
      </div>
    </div>
  </div>
