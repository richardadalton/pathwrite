  ...
  <div class="form-body">
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row">
          <span class="review-key">Full Name</span><span>{d.firstName} {d.lastName}</span>
        </div>
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        ...
        {#if d.company}<div class="review-row">
            <span class="review-key">Company</span><span>{d.company}</span>
          </div>{/if}
        <div class="review-row">
          <span class="review-key">Experience</span><span
            >{EXPERIENCE_LABELS[d.experience] ?? d.experience}</span
          >
        </div>
      </div>
    </div>
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row">
          <span class="review-key">Theme</span><span>{THEME_LABELS[d.theme] ?? d.theme}</span>
        </div>
        <div class="review-row">
