    ...
    <main class="page">
      ...
      <Show when={view() === "sessions"}>
        ...
        <Show when={!sessionsLoading()}>
                ...
                {(session) => (
                  <div class="session-card">
                    ...
                    <div class="session-card__actions">
                      <button class="btn-resume" onClick={() => resumeSession(session.key)}>
                        Resume →
                      </button>
                      <button
          ...
          <div class="new-session-bar">
            <button class="btn-primary btn-new-session" onClick={startNew}>
      ...
      <Show when={view() === "wizard"}>
        <div class="wizard-topbar">
          <button class="btn-back-sessions" onClick={exitToSessions}>
            ← All Sessions
          </button>
      ...
      <Show when={view() === "completed" && completedData()}>
        <section class="result-panel success-panel">
          ...
          <p>
            <strong>{completedData()?.teamName}</strong> — {getMembers().length} member
            {getMembers().length !== 1 ? "s" : ""} onboarded.
          </p>
          ...
          <button class="btn-primary" onClick={exitToSessions}>
            ← Back to Sessions
          </button>
        </section>
      </Show>
      ...
      <Show when={view() === "cancelled"}>
        <section class="result-panel cancel-panel">
          ...
          <button class="btn-secondary" onClick={exitToSessions}>
            ← Back to Sessions
          </button>
        </section>
      </Show>
