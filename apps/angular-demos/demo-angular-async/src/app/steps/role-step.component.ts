  ...
  template: `
    <div class="form-body">
      ...
      <p class="hint">
        ...
        In Angular, services are injected via <code>inject(MockApplicationServices)</code> directly in the
        step component — there is no <code>services</code> prop on <code>pw-shell</code>. This is idiomatic
        Angular DI. The path factory still closes over the same service instance injected in
