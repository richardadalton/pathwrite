...
@Component({
  ...
  styles: [
    `
      ...
      .skip-summary__skipped {
        color: #9ca3af;
        font-style: italic;
      }
      .skip-summary__current {
        color: #2563eb;
        font-weight: 600;
      }
    `,
    ...
    <div class="form-body">
        ...
        <div class="review-card">
          <div class="review-row">
            ...
            <span>
              <span
                class="plan-badge"
                [class.plan-badge--pro]="data.plan === 'paid'"
                [class.plan-badge--free]="data.plan !== 'paid'"
              >
                {{ planLabel(data.plan) }}
              </span>
            </span>
      ...
      @if (data.plan === "paid") {
        <div class="review-section">
          ...
          <div class="review-card">
            <div class="review-row">
              <span class="review-key">Card</span><span>•••• {{ cardLast4 }}</span>
            </div>
            <div class="review-row">
        ...
        <div class="review-section">
          ...
          <div class="review-card">
            <div class="review-row">
              <span class="review-key">Billing</span><span>{{ billingLabel }}</span>
            </div>
...
export class ReviewStepComponent {
  ...
  protected get cardLast4(): string {
    return (this.data.cardNumber as string).slice(-4);
  }
