...
@Component({
  ...
  template: `
    <div class="form-body">
      ...
      @if (errors()["plan"]; as msg) {
        <span class="field-error">{{ msg }}</span>
      }
      @if (data.plan === "free") {
        <p class="plan-note">ℹ️ Free plan — payment and billing steps will be skipped.</p>
      }
    </div>
  `,
})
