...
<template>
  <div v-if="snapshot" class="form-body">
    <p class="step-intro">
      ...
      <strong>Data Scientist</strong> on the first step routes here; other roles skip straight to Review.
    ...
    <p class="hint">
      ...
      engine cached the result in <code>resolvedSkips</code> and the progress bar reflects the true visible
      count.
    </p>
  </div>
</template>
