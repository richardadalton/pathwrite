  ...
  <main class="page">
    ...
    <section v-if="isCompleted && completedData" class="result-panel success-panel">
      ...
      <p>
        ...
        <strong>{{ PLAN_LABELS[completedData.plan] ?? completedData.plan }}</strong> plan.
      </p>
      <div class="summary">
        ...
        <div v-if="completedData.plan === 'paid'" class="summary-section">
          ...
          <div class="summary-row">
            <span class="summary-key">Card</span
            ><span>•••• {{ (completedData.cardNumber as string).slice(-4) }}</span>
          </div>
        </div>
      </div>
