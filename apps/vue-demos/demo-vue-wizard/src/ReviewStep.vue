...
<template>
  <div v-if="snapshot" class="form-body">
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row">
          ...
          ><span>{{ snapshot.data.firstName }} {{ snapshot.data.lastName }}</span>
        </div>
        <div class="review-row">
          <span class="review-key">Email</span><span>{{ snapshot.data.email }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row">
          <span class="review-key">Job Title</span><span>{{ snapshot.data.jobTitle }}</span>
        </div>
        <div v-if="snapshot.data.company" class="review-row">
          <span class="review-key">Company</span><span>{{ snapshot.data.company }}</span>
        </div>
        <div class="review-row">
          <span class="review-key">Experience</span
          ><span>{{ EXPERIENCE_LABELS[snapshot.data.experience] ?? snapshot.data.experience }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row">
          ...
          ><span>{{ THEME_LABELS[snapshot.data.theme] ?? snapshot.data.theme }}</span>
        </div>
        <div class="review-row">
