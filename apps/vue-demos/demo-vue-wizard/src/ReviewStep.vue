  ...
  <div v-if="snapshot" class="form-body">
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        ...
        <div class="review-row"><span class="review-key">Experience</span><span>{{ EXPERIENCE_LABELS[snapshot.data['experience'] as string] ?? snapshot.data['experience'] }}</span></div>
      </div>
    </div>
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row"><span class="review-key">Theme</span><span>{{ THEME_LABELS[snapshot.data['theme'] as string] ?? snapshot.data['theme'] }}</span></div>
