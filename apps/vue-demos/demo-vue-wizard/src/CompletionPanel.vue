...
import type { PathSnapshot } from "@daltonr/pathwrite-vue";
import { EXPERIENCE_LABELS, THEME_LABELS, type OnboardingData } from "./onboarding";

// Receives the completed snapshot from the #completion slot scope.
const props = defineProps<{ snapshot: PathSnapshot<OnboardingData> }>();
...
<template>
  <section class="result-panel success-panel">
    ...
    <div class="summary">
      <div class="summary-section">
        ...
        <div class="summary-row">
          <span class="summary-key">Name</span><span>{{ data.firstName }} {{ data.lastName }}</span>
        </div>
        <div class="summary-row">
          <span class="summary-key">Email</span><span>{{ data.email }}</span>
        </div>
      </div>
      <div class="summary-section">
        <p class="summary-section__title">About You</p>
        <div class="summary-row">
          <span class="summary-key">Job Title</span><span>{{ data.jobTitle }}</span>
        </div>
        <div v-if="data.company" class="summary-row">
          <span class="summary-key">Company</span><span>{{ data.company }}</span>
        </div>
        <div class="summary-row">
      ...
      <div class="summary-section">
        ...
        <div class="summary-row">
          <span class="summary-key">Theme</span><span>{{ THEME_LABELS[data.theme] ?? data.theme }}</span>
        </div>
        <div class="summary-row">
    ...
    <button class="btn-primary" @click="restart()">Start Over</button>
  </section>
</template>
