  ...
  <div class="form-body">
    ...
    <div :class="['outcome-banner', `outcome-banner--${overallStatus}`]">
      ...
      <span>
        ...
        <template v-else-if="overallStatus === 'rejected'"
          >One or more approvers rejected the document.</template
        >
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div class="review-row">
          <span class="review-key">Title</span><span>{{ data?.title }}</span>
        </div>
        <div class="review-row">
          <span class="review-key">Description</span><span>{{ data?.description }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="review-section">
      ...
      <div class="review-card">
        <div v-for="approver in selectedApprovers" :key="approver.id" class="approver-result-row">
