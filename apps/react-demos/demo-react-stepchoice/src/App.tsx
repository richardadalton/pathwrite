              ...
              {result.country === "US" ? (
                <>
                  <div className="summary-row">
                    <span className="summary-key">Street</span>
                    <span>
                      {result.streetAddress}
                      {result.aptUnit ? `, ${result.aptUnit}` : ""}
                    </span>
                  </div>
                  <div className="summary-row">
                  ...
                  <div className="summary-row">
                    <span className="summary-key">ZIP</span>
                ...
                <>
                  <div className="summary-row">
                    <span className="summary-key">Line 1</span>
                    <span>{result.addressLine1}</span>
                  </div>
                  {result.addressLine2 && (
                    <div className="summary-row">
                      <span className="summary-key">Line 2</span>
                      <span>{result.addressLine2}</span>
                    </div>
                  )}
                  <div className="summary-row">
                    <span className="summary-key">Town</span>
                    <span>{result.town}</span>
                  </div>
                  <div className="summary-row">
                    <span className="summary-key">County</span>
                    <span>{result.county}</span>
                  </div>
                  {result.eircode && (
                    <div className="summary-row">
                      <span className="summary-key">Eircode</span>
                      <span>{result.eircode}</span>
                    </div>
                  )}
                  <div className="summary-row">
                    <span className="summary-key">Country</span>
