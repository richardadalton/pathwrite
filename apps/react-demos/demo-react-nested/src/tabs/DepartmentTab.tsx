      ...
      <div className="form-body">
        ...
        <div className="field">
          <label htmlFor="manager">
            Reporting Manager <span className="optional">(optional)</span>
          </label>
          <input
            id="manager"
            type="text"
        ...
        <div className="field">
          <label htmlFor="office">
            Office Location <span className="optional">(optional)</span>
          </label>
          <select id="office" value={data.office ?? ""} onChange={(e) => setData("office", e.target.value)}>
