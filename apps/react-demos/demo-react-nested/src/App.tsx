    ...
    <main className="page">
      <div className="page-header">
        ...
        <p className="subtitle">
          Nested PathShell stress-test — an independent Employee Details path runs inside Step 2. Data syncs
          to the parent via <code>onEvent</code>; the parent's <code>canMoveNext</code> guard validates the
          inner data.
        </p>
      </div>
            ...
            <section className="result-panel success-panel">
              ...
              <div className="summary">
                ...
                <div className="summary-section">
                  ...
                  {d.manager && (
                    <div className="summary-row">
                      <span className="summary-key">Manager</span>
                      <span>{d.manager}</span>
                    </div>
                  )}
                  {d.office && (
                    <div className="summary-row">
                      <span className="summary-key">Office</span>
                      <span>{d.office}</span>
                    </div>
                  )}
                </div>
                <div className="summary-section">
                  ...
                  <div className="summary-row">
                    <span className="summary-key">Laptop</span>
