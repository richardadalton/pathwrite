  ...
  return (
    <div className="form-body">
      ...
      <p className="hint">
        ...
        <code>snapshot.stepCount</code> included this step optimistically. Once navigation walked past it (or
        landed on it), the engine cached the result in <code>resolvedSkips</code> and the progress bar
