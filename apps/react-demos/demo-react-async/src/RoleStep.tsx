    ...
    <div className="form-body">
      ...
      <div className={`field ${errors.roleId ? "field--error" : ""}`}>
        ...
        {loading ? (
          ...
          <select id="roleId" value={snap.data.roleId} onChange={(e) => setData("roleId", e.target.value)}>
      ...
      <p className="hint">
        ...
        <code>services.getRoles()</code> in a <code>useEffect</code> and manages its own loading state —
        keeping option lists out of the submission payload.
      </p>
    </div>
  );
}
