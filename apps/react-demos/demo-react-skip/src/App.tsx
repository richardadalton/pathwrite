    ...
    <main className="page">
      ...
      {isCompleted && completedData && (
        <section className="result-panel success-panel">
          ...
          <p>
            You're signed up for the <strong>{PLAN_LABELS[completedData.plan] ?? completedData.plan}</strong>{" "}
            plan.
          </p>
          <div className="summary">
            <div className="summary-section">
              ...
              <div className="summary-row">
                ...
                <span>{PLAN_LABELS[completedData.plan]}</span>
              </div>
            </div>
            <div className="summary-section">
            ...
            {completedData.plan === "paid" && (
              <div className="summary-section">
                ...
                <div className="summary-row">
                  <span className="summary-key">Card</span>
                  <span>•••• {completedData.cardNumber.slice(-4)}</span>
                </div>
              </div>
            )}
          </div>
