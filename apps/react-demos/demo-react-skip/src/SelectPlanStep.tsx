  ...
  return (
    <div className="form-body">
      <p className="step-intro">
        Choose the plan that's right for you. Free gets you started — upgrade anytime.
      </p>
      ...
      {data.plan === "free" && (
        <p className="plan-note">ℹ️ Free plan — payment and billing steps will be skipped.</p>
      )}
    </div>
  );
}
